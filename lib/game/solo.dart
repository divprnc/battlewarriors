                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              Text("Winning Prizes", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold, fontFamily: "OpenSans")),
                                                                              Divider(
                                                                                color: Colors.white,
                                                                                height: 2,
                                                                              ),
                                                                              ...
                                                                              Center(
                                                                                child: Row(
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                    ...
                                                                                    Text(
                                                                                      "₹ " + snapshot.data[index].data["Prize"]["Rank_2_to_10"].toString(),
                                                                                      style: TextStyle(
                                                                                        color: Colors.white,
                                                                                        fontSize: 15,
                                                                                      ),
                                                                              ...
                                                                              Center(
                                                                                child: Row(
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                    ...
                                                                                    Text(
                                                                                      "₹ " + snapshot.data[index].data["Prize"]["Rank_11_to_20"].toString(),
                                                                                      style: TextStyle(
                                                                                        color: Colors.white,
                                                                                        fontSize: 15,
                                                                                      ),
                                                                              ...
                                                                              Center(
                                                                                child: Row(
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                    ...
                                                                                    Text(
                                                                                      "₹ " + snapshot.data[index].data["Prize"]["Rank_21_to_40"].toString(),
                                                                                      style: TextStyle(
                                                                                        color: Colors.white,
                                                                                        fontSize: 15,
                                                                                      ),
  ...
  Future<void> joinContest() async {
    ...
    if (pubgid == null || pubgid == "") {
      ...
      if(remainingSeats != 0) {
        ...
        // print("winningWallet $winningWallet");
        // print("walletAmount $walletAmount");
        // print("tempwinwallet $tempwinwallet");
        // print("finalwinwallet $finalwinwallet");
        Map<String, dynamic> transferData = {
          "Transfer": "OUT",
          "Date": formattedDate,
          "Time": time,
