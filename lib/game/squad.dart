          ...
          : FutureBuilder(
              ...
              builder: (_, AsyncSnapshot<List<DocumentSnapshot>> snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(
                    child: Text(
                      "Currently no active games are here...",
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (_, index) {
                        String date = DateFormat("yyyy-MM-dd HH:mm:ss")
                            .format(DateTime.now());
                        String cdate =
                            snapshot.data[index].data["GameData"]["Date"];
                        List dater = cdate.split("/").reversed.toList();
                        String finalDate = dater.join('-');
                        String ctime = snapshot
                            .data[index].data["GameData"]["Time"]
                            .toString()
                            .toUpperCase();
                        String temptime =
                                                              ...
                                                              onPressed: () {
                                                                showModalBottomSheet(
                                                                  ...
                                                                  builder:
                                                                      (context) {
                                                                    return Container(
                                                                        child: snapshot.data[index].data["GameData"]["Type"].toString() ==
                                                                                "Free"
                                                                            ? Container(
                                                                                height: 270,
                                                                                child: Center(
                                                                                  child: Column(
                                                                                    ...
                                                                                    children: <Widget>[
                                                                                      ...
                                                                                      Text("Winning Prizes", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold, fontFamily: "Quicksand")),
                                                                                      Divider(
                                                                                        color: Colors.white,
                                                                                        height: 2,
                                                                                      ),
                                                                                      Center(
                                                                                        child: Row(
                                                                                          ...
                                                                                          children: <Widget>[
                                                                                            Text(
                                                                                              "Maximum Winning Prize for First Rank Team",
                                                                                              style: TextStyle(color: Colors.white, fontSize: 15, fontFamily: "Quicksand"),
                                                                                            ),
                                                                                            Text(
                                                                                              "₹ " + snapshot.data[index].data["Prize"]["RankFirst"].toString(),
                                                                                              style: TextStyle(
                                                                                                color: Colors.white,
      ...
      if (remainingSeats != 0) {
        if (walletAmount >= totalFees) {
          ...
          await Firestore.instance
           ...
           Firestore.instance
              .document("LiveGames/$againgameId")
              .updateData({
          ...
          await Firestore.instance.document("UserJoinedGame/$uid").updateData({
            "JoinedGames": joinedGames,
                ...
                _scaffoldKey.currentState.showSnackBar(SnackBar(
                  ...
                  content: allAccountController == true
                      ? Text(
          ...
          _scaffoldKey.currentState.showSnackBar(SnackBar(
            ...
            content: Text(
              ...
              style: TextStyle(
                  fontSize: 15, color: Colors.white, fontFamily: "Quicksand"),
            ),
            duration: Duration(seconds: 4),
          ));
        }
